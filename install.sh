...
print_usage_summary() {
    ...
    if [[ ":$PATH:" == *":$INSTALL_DIR:"* ]]; then
        echo "  mo                # 交互式菜单"
        echo "  mo clean          # 系统清理"
        echo "  mo uninstall      # 卸载应用程序"
        echo "  mo update         # 更新 Mole 到最新版本"
        echo "  mo remove         # 从系统中移除 Mole"
        echo "  mo --version      # 显示已安装版本"
        echo "  mo --help         # 显示此帮助信息"
    else
        echo "  $INSTALL_DIR/mo                # 交互式菜单"
        echo "  $INSTALL_DIR/mo clean          # 系统清理"
        echo "  $INSTALL_DIR/mo uninstall      # 卸载应用程序"
        echo "  $INSTALL_DIR/mo update         # 更新 Mole 到最新版本"
        echo "  $INSTALL_DIR/mo remove         # 从系统中移除 Mole"
        echo "  $INSTALL_DIR/mo --version      # 显示已安装版本"
        echo "  $INSTALL_DIR/mo --help         # 显示此帮助信息"
    fi
    echo ""
}
